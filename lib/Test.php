...
<head>
    ...
    <script src="http://code.jquery.com/ui/1.9.1/jquery-ui.js"></script>
		...
		<script type="text/javascript">
			$(function(){
                ...
                $("#countries").addClass(".ui-helper-zfix");
            
            
                $("#ajaxButton").button().click(function(){
                   $("#ajaxButton").val("abc"); 
                    $("#ajax_filler").load("test.php");
                });
	...
	<body class="ui-form">
		...
		<h1 style="text-align: center;">jQuery UI for TSSV</h1>
		<p style="font-size: 1.3em; line-height: 1.5; margin: 1em 0; text-align: center;">
        ...
        <div id="ajax_filler" style="width: 300; height: 300; color: yellow; background-color: green; text-align: center;">
            Placeholder for items returned by AJAX
            <br />
            <input type="button" id="ajaxButton" value="Ajax Button" style="text-align: center; float: inherit;"/>
        </div>
